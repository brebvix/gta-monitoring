            ...
            <table border="0" cellpadding="0" cellspacing="0" width="500" style="padding: 0 0 20px 0;"
                ...
                <tr>
                    <td align="center" class="padding-copy" colspan="2"
                        ...
                        <strong><?= Yii::t('main', 'Новое уведомление Servers.Fun') ?></strong></td>
                </tr>
                </tbody>
            </table>
        </td>
...
<table border="0" cellpadding="0" cellspacing="0" width="100%" id="ko_compactarticleBlock_4">
    ...
    <tr class="row-a">
        <td bgcolor="#f5f5f5" align="center" class="section-padding" style="padding: 0px 15px 0px 15px;">
            <table border="0" cellpadding="0" cellspacing="0" width="500" style="padding: 0 0 20px 0;"
                ...
                <tbody>
                <tr>
                    <td valign="top" style="padding: 40px 0 0 0;" class="mobile-hide"><img
                                alt="User <?= $username ?> avatar" width="105" border="0"
    ...
    <?= Yii::t('main', 'Здравствуйте') ?>, <?= $username ?>!
                                </td>
                            </tr>
                            <tr>
                                <td align="left" class="padding-copy articletextintenseStyle"
                                    ...
                                    <p><?= Yii::t('main', 'Уведомляем Вас, что время действия услуги выделение цветом для сервера') ?>
                                        <i><?= $server_title ?></i>
<?= Yii::t('main', 'закончилось. Если Вы желаете продлить выделение сервера цветом - перейдите по ниже указанной ссылке:') ?></p></td>
                            </tr>
                            <tr>
                                                                ...
                                                                <tr>
                                                                    <td align="center">
                                                                        <a target="_new" class="mobile-button"
                                                                           ...
                                                                           href="<?= Yii::$app->urlManager->createAbsoluteUrl(['/server/view', 'id' => $server_id]) ?>"><?= Yii::t('main', 'Продлить закрепление в ТОПе') ?>&nbsp;→</a>
