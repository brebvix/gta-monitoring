                        ...
                        <table border="0" cellspacing="0" cellpadding="0" width="100%">
                            ...
                            <tr>
                                <td align="left" class="padding-copy articletextintenseStyle"
                                    ...
                                    <p><?= Yii::t('main', 'Уведомляем Вас, что время действия услуги закрепления сервера') ?>
                                        <i><?= $server_title ?></i>
                                        <?= Yii::t('main', 'в ТОПе закончилась. Если Вы желаете продлить закрепление сервера в ТОПе - перейдите по ниже указанной ссылке:') ?>
                                        </p></td>
                            </tr>
                            <tr>
                                                                ...
                                                                <tr>
                                                                    <td align="center">
                                                                        <a target="_new" class="mobile-button"
                                                                           ...
                                                                           href="<?= Yii::$app->urlManager->createAbsoluteUrl(['/server/view', 'id' => $server_id]) ?>">
<?= Yii::t('main', 'Продлить закрепление в ТОПе') ?>&nbsp;→</a>
                                                                    </td>
                                                                </tr>
                                                                </tbody>
                                                            </table>
