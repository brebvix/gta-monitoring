                        ...
                        <table border="0" cellspacing="0" cellpadding="0" width="100%">
                            ...
                            <tr>
                                <td align="left" class="padding-copy articletextintenseStyle"
                                    ...
                                    <p><?= Yii::t('main', 'Уведомляем Вас, что срок аренды баннера') ?>
                                        №<?= $banner_position ?>
                                        ...
                                        <?= Yii::t('main', 'Если Вы желаете продлить аренду, перейдите по ниже указанной ссылке:') ?></p>
                                </td>
                            </tr>
                            <tr>
                                                                ...
                                                                <tr>
                                                                    <td align="center">
                                                                        <a target="_new" class="mobile-button"
                                                                           ...
                                                                           href="<?= Yii::$app->urlManager->createAbsoluteUrl(['/advertising/banner/buy', 'position' => $banner_position]) ?>">
                                                                            <?= Yii::t('main', 'Продлить аренду') ?>
                                                                            &nbsp;→</a>
