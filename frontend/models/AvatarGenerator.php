...
class AvatarGenerator {
     ...
     * @param string $id
     */
    public static function render($size = 200, $gender = null, $id = null) {
    ...
    public static function generate($size = 400, $gender = 'male', $id = null) {
        ...
        //}
        //if ($id)
        //    srand((int) base_convert(substr(md5($id), 0, 8), 16, 10));

        $layerList = self::getLayerList();
        $imgPath = 'images' . DIRECTORY_SEPARATOR . 'avatar_generator' . DIRECTORY_SEPARATOR;
    ...
    private static function getLayerList() {
        ...
        foreach (scandir('images' . DIRECTORY_SEPARATOR . 'avatar_generator') as $file) {
