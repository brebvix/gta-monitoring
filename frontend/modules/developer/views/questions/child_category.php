...
$this->title = $parent_category . ', ' . Yii::t('questions', $category) . ' - ' . Yii::t('questions', 'вопросы и ответы');

Yii::$app->params['breadcrumbs'][] = ['label' => Yii::t('questions', 'Список вопросов'), 'url' => ['/developer']];
Yii::$app->params['breadcrumbs'][] = Yii::t('questions', $category);

Yii::$app->params['description'] = $parent_category . ', ' . Yii::t('questions', $category) . ' - ' . Yii::t('questions', 'сервис вопросов и ответов.');
...
<div class="row">
    ...
    <div class="col-sm-12 col-md-12 col-lg-9 col-xlg-9">
        <div class="text-center">
            <h1><?= Yii::t('questions', 'Вопросы в категории') ?> <i><?= $parent_category ?></i> > <i><?= Yii::t('questions', $category) ?></i></h1>
        </div>
        <div class="row">
            <?= ListView::widget([
