...
$this->title = $tag . ' - ' . Yii::t('questions', 'вопросы и ответы');

Yii::$app->params['breadcrumbs'][] = ['label' => Yii::t('questions', 'Список вопросов'), 'url' => ['/developer']];
Yii::$app->params['breadcrumbs'][] = $tag;

Yii::$app->params['description'] = $tag . ' - ' . Yii::t('questions', 'сервис вопросов и ответов.');
...
<div class="row">
    ...
    <div class="col-sm-12 col-md-12 col-lg-9 col-xlg-9">
        <div class="text-center">
            <h1><?= Yii::t('questions', 'Вопросы с тегом') ?> <i><?= $tag ?></i></h1>
        </div>
        <div class="row">
            <?= ListView::widget([
