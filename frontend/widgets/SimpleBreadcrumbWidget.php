 ...
 * @since 2.0
 */
class SimpleBreadcrumbWidget extends Widget
{
    /**
    ...
    public function run()
    {
        ...
        foreach ($this->links as $link) {
            ...
            $links[] = $this->renderItem($link, isset($link['url']) ? $this->itemTemplate : $this->activeItemTemplate, $position);
        }
     ...
     */
    protected function renderItem($link, $template, $position)
    {
        ...
        if (isset($link['url'])) {
            ...
            $options['itemtype'] = 'http://schema.org/Thing';
            $options['itemprop'] = 'item';
            $options['itemscope'] = '';
            $options['href'] = $link['url'];
            $options['itemid'] = '#' . $position;
            $label = '<span itemprop="name">' . $label . '</span>';
            $link = Html::a($label, $link['url'], $options);
        } else {
            $label = '<a itemtype="http://schema.org/Thing" itemscope itemprop="item" itemid="#" href="#"><span itemprop="name">' . $label . '</span></a>';
