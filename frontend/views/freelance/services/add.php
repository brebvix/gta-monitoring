            ...
            <div class="row">
                ...
                <div class="col-xlg-9 col-lg-9 col-md-9">
                    ...
                    <div class="card-body p-t-0">
                        ...
                        <br>
                        <?= $form->field($addModel, 'minimum_price')->textInput() ?>
                        <br>
                        <?= $form->field($addModel, 'price_per_hour')->textInput() ?>
                        <br>
                        <?= $form->field($addModel, 'portfolio_link')->textInput() ?>
                        <br>
                        <?= $form->field($addModel, 'vacancie_id')->widget(Select2::classname(), [
                            'data' => $vacanciesListForDropDown,
                            'options' => ['placeholder' => Yii::t('main', 'Выберите категорию услуги ...')],
